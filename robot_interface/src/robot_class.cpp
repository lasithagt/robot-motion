...
namespace robot_interface {
  ...
  void robotKUKA::init(ros::NodeHandle& nh_states, ros::NodeHandle& nh_command) {	
      ...
      handler_command_joint_torque_.init("/kuka/command/command_torque", nh_command);
  ...
  void robotKUKA::setJointTorque(const iiwa_msgs::JointTorque& torque)  {
    handler_command_joint_torque_.set(torque);
    handler_command_joint_torque_.publishIfNew();
  }
